...
1. - [ ] Make sure your repo-root `.env` (shared by both apps) matches the values listed in [Environment Variables](https://www.notion.so/getditto/Environment-Variables-78261e05a2b44a299ee388f06e9ff86a?pvs=4#98228b9fc4ea4049b20aa33f8d638bec); otherwise the app won't sync with the existing versions. (`Env.swift` is generated from `.env` at build time — no need to check it separately.)
